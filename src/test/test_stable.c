...
void test_st_create_symbol_success(void)
{
    ...
    symb *s1 = st_create_symbol(n1, a1, 4, INT_T, VAR, 4, 0);
...
void test_st_add_symbol_insert_success(void)
{
    ...
    symb *s1 = st_add_symbol(n1, a1, 4, INT_T, VAR, 4, 0);
    TEST_ASSERT_NOT_NULL(s1);
    TEST_ASSERT_EQUAL_STRING(n1, s1->name);
    TEST_ASSERT_EQUAL_STRING(a1, s1->addr);
}
...
void test_st_add_symbol_insert_fail_already_in_table(void)
{
    ...
    sprintf(a1, "gp_");
    sprintf(a3, "gp_");
    st_add_symbol(n1, a1, 4, INT_T, VAR, 4, 0);
    symb *s2 = st_add_symbol(n3, a3, 4, INT_T, VAR, 4, 0);
    TEST_ASSERT_NULL(s2);
    free(n3);
    free(a3);
}
...
void test_st_add_symbol_collision_success(void)
{
    ...
    TEST_ASSERT_NOT_NULL(st_add_symbol(n1, a1, 4,INT_T, VAR, 4, 0));
    TEST_ASSERT_NOT_NULL(st_add_symbol(n2, a2, 4,INT_T, VAR, 4, 0));
}
